# Overview: Asp.Net Core MVC E-Commerce Shop Application
This project is a backend web application that is an e-commerce website selling various consumer product. The project developed using Asp.Net Core MVC, used Microsoft SQL Server as a database. It is a single solution project divided into two parts first is Client Side (Main Website) and second is Admin Side (Control). 
...
- Used Web API
 ...
 <img width="960" alt="Ekran görüntüsü 2024-03-15 112729" src="https://github.com/Esrakaya1/Shopapp/assets/108301268/af0b8c79-b284-4ca6-9475-a5cb74a09ac4">

- To Login as an Adminuser or Customeruser:
- Username: adminuser@shopapp.com, customeruser@shopapp.com
