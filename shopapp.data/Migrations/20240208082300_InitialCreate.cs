    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "iyi telefon", "1.jpg", true, false, "Samsung s5", 20000.0, "samsung-s5" },
                    { 2, "iyi telefon", "2.jpg", false, false, "Samsung s6", 20000.0, "samsung-s6" },
                    { 3, "iyi telefon", "3.jpg", true, false, "Samsung s7", 20000.0, "samsung-s7" },
                    { 4, "iyi telefon", "4.jpg", false, false, "iphone 11 ", 25000.0, "iphone-11" },
                    { 5, "iyi telefon", "4.jpg", false, false, "iphone 11 ", 25000.0, "iphone-11" }
                });
